...
void Editor::updateScreen()
{
    ...
    while (i < BUFFER_SIZE)
    {
        ...
        if (b == '\n')
        {
            ...
            if (totalLine < BUFFER_SIZE + 1)  // Prevent array overflow
...
void Editor::addChar(int c)
{
    ...
    // Double boundary check: both bufferSize and cursorPos must be within limits
...
void Editor::removeLastWord()
{
    ...
    int start = end;
    // Improved readability: check start > 0 for buffer[start-1] access
